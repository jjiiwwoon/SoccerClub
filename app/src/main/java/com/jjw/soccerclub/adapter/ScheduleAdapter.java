...
public class ScheduleAdapter extends RecyclerView.Adapter<ScheduleAdapter.ScheduleViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ScheduleViewHolder holder, int position) {
        ...
        // TODO: 운영 전환 시 아래 주석 해제하고 테스트 모드 코드 제거
        // long now = System.currentTimeMillis();
        // boolean timePassed = item.matchTs > 0 && now >= item.matchTs;
        // boolean finished   = "finished".equals(item.status);
        // holder.btnWriteRecord.setVisibility((timePassed || finished) ? View.VISIBLE : View.GONE);
